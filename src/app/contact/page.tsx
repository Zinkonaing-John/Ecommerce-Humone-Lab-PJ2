        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label htmlFor="name" className="block text-black text-sm font-bold mb-2">Your Name</label>
                <input
                  type="text"
                  id="name"
                  name="name"
              ...
              <div>
                <label htmlFor="email" className="block text-black text-sm font-bold mb-2">Your Email</label>
                <input
                  type="email"
                  id="email"
                  name="email"
              ...
              <div>
                <label htmlFor="message" className="block text-black text-sm font-bold mb-2">Message</label>
                <textarea
                  id="message"
                  name="message"
                  className="shadow appearance-none border rounded w-full py-2 px-3 text-black leading-tight focus:outline-none focus:shadow-outline"
              ...
              {messageSent && (
                <p className="text-primary text-center mt-4">Thank you for your message! We'll get back to you soon.</p>
              )}
            </form>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4 text-black text-lg">
              ...
              <p>
                <span className="font-semibold">Address:</span> 123 Design Street, Suite 456, Creative City, CA 90210
              </p>
              <p className="pt-4">
